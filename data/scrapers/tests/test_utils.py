from exam_scraper.core import sanitize_filename
from exam_scraper.core import canonicalize_subject, extract_year, url_hash
...
def test_sanitize_filename():
    ...
    assert sanitize_filename("Sở GD&ĐT Hưng Yên") == "so_gd_dt_hung_yen"
